...
<meta name="description"
	content="A demo for my simple plugin that enables Bootstrap dropdowns to activate on hover and provide a nice user experience.">
		...
		<div class="container">
			...
			<div class="navbar-collapse nav-collapse collapse navbar-header">
				<ul class="nav navbar-nav">
					<li class="dropdown"><a href="#" class="dropdown-toggle js-activated">Dropdown <b class="caret"></b></a>
					...
					<li class="dropdown"><a href="#" class="dropdown-toggle js-activated" data-toggle="dropdown">I Have a
...
-->
					...
					<li class="dropdown"><a href="#" class="dropdown-toggle js-activated" data-toggle="dropdown">Account <b
							class="caret"></b></a>
						<ul class="dropdown-menu">
					...
					<li class="dropdown"><a href="#" class="dropdown-toggle js-activated" data-toggle="dropdown">Contact <b
							class="caret"></b></a>
						<ul class="dropdown-menu">
	...
	<div class="container">
		<div class="col-12">
			<div class="alert alert-danger">
				<strong>Please note</strong> that Bootstrap 3 <em>does not</em> support submenus. See <a
					href="https://github.com/twbs/bootstrap/pull/6342#issuecomment-11594010">this comment</a> from one of the original
				authors.
			</div>

			<h1>Bootstrap: Dropdown on Hover Plugin Demo</h1>
			<p>
				Hover over the nav items to see that they activate on hover. I'm setting the instantlyCloseOthers flag to true, so
				when you hover over a new nav item, the other ones instantly close (instead of waiting for their timeouts). See <a
					href="http://cameronspear.com/blog/bootstrap-dropdown-on-hover-plugin/">cameronspear.com/blog/bootstrap-dropdown-on-hover-plugin/</a>
				for more.
			</p>

			<h2>
				<em>New!</em> Try it with data-attributes
			</h2>

			<div class="btn-toolbar">
				<div class="btn-group">
					<button class="btn dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="1000">
						1000ms Delay <b class="caret"></b>
					</button>
					<ul class="dropdown-menu">
						<li><a tabindex="-1" href="#">Why Would</a></li>
						<li><a tabindex="-1" href="#">A Home Tab</a></li>
				...
				<div class="btn-group">
					<button class="btn dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="false">
						Doesn't Close Others <b class="caret"></b>
					</button>
					<ul class="dropdown-menu">
						<li><a tabindex="-1" href="#">My Account</a></li>
						<li class="divider"></li>
			...
			<div class="btn-toolbar">
				...
				<!-- .btn-group -->
				<div class="btn-group">
					<button class="btn btn-primary dropdown-toggle" data-toggle="dropdown" data-hover="dropdown">
				...
				<!-- .btn-group -->
				<div class="btn-group">
					<button class="btn btn-danger dropdown-toggle" data-toggle="dropdown" data-hover="dropdown">
				...
				<!-- .btn-group -->
				<div class="btn-group">
					<button class="btn btn-warning dropdown-toggle" data-toggle="dropdown" data-hover="dropdown">
				...
				<!-- .btn-group -->
				<div class="btn-group">
					<button class="btn btn-info dropdown-toggle" data-toggle="dropdown" data-hover="dropdown">
			...
			<div class="tabs-example">
				<ul id="myTab" class="nav nav-tabs">
					...
					<li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown">Dropdown
							<b class="caret"></b>
					</a>
						<ul class="dropdown-menu">
				...
				<div id="myTabContent" class="tab-content">
					...
					<div class="tab-pane fade" id="profile">
						<p>Food truck fixie locavore, accusamus mcsweeney's marfa nulla single-origin coffee squid. Exercitation +1
							...
							PBR. Homo nostrud organic, assumenda labore aesthetic magna delectus mollit. Keytar helvetica VHS salvia yr, vero
							...
							qui sapiente accusamus tattooed echo park.</p>
					</div>
